...
namespace SGE.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Ano")] Materias materias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Ano")] Materias materias)
        {
            if (id != materias.Id)
            {
                return NotFound();
